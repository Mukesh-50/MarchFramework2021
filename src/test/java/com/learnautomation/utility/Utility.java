...
public class Utility 
{
	...
	{
		 String text =getElement(driver, locator).getText();
	...
	public static void ExplicitClick(WebDriver driver, By locator)
	{
	...
	public static void ExplicitWaitVisibilityType(WebDriver driver, By locator , String value)
	{
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
	...
	public static void javaSrcriptExeType(WebDriver driver, By locator , String value )
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public static void javaSrcriptExeClick(WebDriver driver, By locator  )
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
		WebElement ele = driver.findElement(locator);
